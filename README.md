# St Andrews University Research Computing Network Launch Event
...
What do you want to see at the event? Submit pull requests, open issues, chat on gitter (https://gitter.im/StAResComp/rescomp-network-launch), email the list or pgm5 (also on Skype for Business).
